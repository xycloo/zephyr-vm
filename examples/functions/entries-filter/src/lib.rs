...
use soroban_sdk::{contracttype, xdr::{FromXdr, ReadXdr, ScVal, ToXdr}, Address, Bytes, Env, Symbol, TryFromVal, TryIntoVal, Val};
...
pub extern "C" fn top_holders() {
    ...
    let addr =  soroban_sdk::Address::from_string(&soroban_sdk::String::from_str(&env, "GBLEJ7XTXCVHOCLPLM33JLBKT3OVOQXL3KRRWY6UUY44UO4XNWC44ZNM"));
